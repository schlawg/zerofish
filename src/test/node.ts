...
rl.on('line', (line: string) => {
  ...
  else if (line === '2') zf.setZeroWeights(fs.readFileSync(`${__dirname}/../../wasm/weights/tinygyal-8.pb`));
  else if (line === '3') zf.setZeroWeights(fs.readFileSync(`${__dirname}/../../wasm/weights/goodgyal-5.pb`));
  else if (line === '4') zf.setZeroWeights(fs.readFileSync(`${__dirname}/../../wasm/weights/badgyal-8.pb`));
  else if (line === '5') zf.setZeroWeights(fs.readFileSync(`${__dirname}/../../wasm/weights/t79-192x15.pb`));
